...
Descarga ecommailcontent-1.0.5.zip.

Ve a Módulos > Gestor de módulos.

Pulsa Subir un módulo.

Selecciona el ZIP.

Instálalo.

Abre la configuración y crea las reglas.
...
Verifica HTML y texto plano.

Comprueba distintos clientes de correo si añades HTML complejo.
